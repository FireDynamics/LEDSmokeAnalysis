...
class ConfigDataAnalysis(cp.ConfigParser):
    ...
    def __init__(self, load_config_file=True, camera_position=None, num_of_layers=20, domain_bounds=None,
        ...
        :param num_of_layers: Number of horizontal smoke layers. Defaults to 20.
        ...
        :param led_arrays: LED arrays for which the extinction coefficients should be computed. Defaults to None.
    ...
    def in_num_of_layers(self) -> None:
        """
